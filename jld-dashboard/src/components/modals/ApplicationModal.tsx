    ...
    <ModalFrame onClose={onClose} title='Application form'>
      <div className="bg-white rounded-2xl max-w-3xl w-full border border-slate-200 shadow-xl overflow-hidden my-6 animate-in fade-in zoom-in-95 duration-150">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <select
                ...
                className="w-full bg-white border border-slate-200 rounded-xl px-3 py-2 text-xs text-slate-800 focus:ring-2 focus:ring-emerald-600/20 focus:border-emerald-600 outline-none shadow-2xs"
              >
                {clients.map(c => (
          ...
          <div className="bg-slate-50/60 p-4 rounded-xl border border-slate-100 grid grid-cols-2 sm:grid-cols-4 gap-3.5">
            <div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-white border border-slate-200 rounded-lg px-2.5 py-1.5 text-xs text-slate-900 font-semibold focus:border-emerald-600 outline-none"
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div className="bg-emerald-50/70 border border-emerald-200/80 rounded-xl p-3 flex flex-col justify-center">
              <span className="text-[10px] uppercase font-semibold text-emerald-800 tracking-wider flex items-center gap-1">
                <Calculator className="w-3 h-3 text-emerald-700" />
                Monthly Amortization (15% APR)
              </span>
              <span className="text-lg font-bold text-emerald-950 mt-1">
          ...
          <div className="pt-4 border-t border-slate-100 flex items-center justify-end gap-2.5">
            <button
              type="button"
              onClick={onClose}
              className="px-4 py-2 bg-slate-100 hover:bg-slate-200/80 text-slate-700 text-xs font-semibold rounded-xl transition-colors cursor-pointer"
            >
              Cancel
            </button>
            <button
              type="submit"
              className="px-5 py-2 bg-[#00593B] hover:bg-[#004a31] text-white text-xs font-semibold rounded-xl shadow-sm transition-all cursor-pointer"
            >
