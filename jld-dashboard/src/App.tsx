...
export function App() {
  ...
  const handleSaveApplication = (newApp: PurchaseDetail):string|void => {
    ...
    if(newApp.amortization != null && (!Number.isFinite(newApp.amortization)||newApp.amortization<0))return 'Monthly amortization must be a valid amount of zero or more when it is entered.';
    ...
    <div className="app-shell-root flex min-h-screen bg-[#F8FAFC]">
      ...
      <div className="app-main-viewport flex-1 flex flex-col min-w-0">
        ...
        <div className="app-content-viewport flex-1 pb-10 erp-content">
          ...
          {currentTab === 'printable-accounts' && <PrintableAccountsPage />}
