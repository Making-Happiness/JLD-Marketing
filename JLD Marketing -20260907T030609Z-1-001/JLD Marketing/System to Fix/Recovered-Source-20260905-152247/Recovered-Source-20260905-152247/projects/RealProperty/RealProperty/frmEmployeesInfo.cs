...
public class frmEmployeesInfo : Form
{
	...
	private ComboBox cbmode_of_salary;
	...
	private void bindData()
	{
		...
		cbmode_of_salary.DataBindings.Add("SelectedIndex", employee, "mode_of_salary     ".Trim(), formattingEnabled: false, DataSourceUpdateMode.OnPropertyChanged);
	}
	...
	private void btnSave_Click(object sender, EventArgs e)
	{
		...
		{
			using (EmployeeCtrl newEmployeeCtrl = new EmployeeCtrl())
			{
				int num = newEmployeeCtrl.add(employee);
				if (num > 0)
				{
					commitcahanges = true;
	...
	{
		lblDailyRate.Text = $"Daily Rate = Mo/26 Day = {Math.Round(numSalary.Value / 26m, 2)}";
	}
	...
	private void InitializeComponent()
	{
		...
		this.cbmode_of_salary = new System.Windows.Forms.ComboBox();
		...
		base.SuspendLayout();
		this.groupBox1.Controls.Add(this.cbmode_of_salary);
		...
		this.cbmode_of_salary.FormattingEnabled = true;
		this.cbmode_of_salary.Items.AddRange(new object[2] { "monthly", "weekly" });
		this.cbmode_of_salary.Location = new System.Drawing.Point(615, 378);
		this.cbmode_of_salary.Name = "cbmode_of_salary";
		this.cbmode_of_salary.Size = new System.Drawing.Size(213, 26);
		this.cbmode_of_salary.TabIndex = 50;
		this.label13.AutoSize = true;
		this.label13.Location = new System.Drawing.Point(612, 356);
		this.label13.Name = "label13";
		this.label13.Size = new System.Drawing.Size(106, 18);
		this.label13.TabIndex = 49;
		this.label13.Text = "mode of salary";
		...
		this.numSalary.ValueChanged += new System.EventHandler(numSalary_ValueChanged);
		...
		this.lblDailyRate.Location = new System.Drawing.Point(295, 177);
		this.lblDailyRate.Name = "lblDailyRate";
		this.lblDailyRate.Size = new System.Drawing.Size(177, 18);
		this.lblDailyRate.TabIndex = 1;
		this.lblDailyRate.Text = "Daily Rate = Mo/26Day = ";
