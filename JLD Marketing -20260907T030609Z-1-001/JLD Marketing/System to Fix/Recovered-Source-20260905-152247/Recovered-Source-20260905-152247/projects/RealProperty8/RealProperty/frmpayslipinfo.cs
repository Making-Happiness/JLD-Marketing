...
public class frmpayslipinfo : Form
{
	...
	private void cbForthemonthof_SelectedIndexChanged(object sender, EventArgs e)
	{
		if (cbTitle.Text == "" || cbForthemonthof.Items.Contains(cbTitle.Text))
		{
	...
	private void InitializeComponent()
	{
		...
		this.cbTitle.Location = new System.Drawing.Point(12, 87);
		...
		this.cbModeofPosting.Items.AddRange(new object[2] { "Auto", "Manual" });
		...
		this.cbForthemonthof.Location = new System.Drawing.Point(12, 155);
		...
		this.cbForthemonthof.SelectedIndexChanged += new System.EventHandler(cbForthemonthof_SelectedIndexChanged);
		...
		base.ClientSize = new System.Drawing.Size(552, 499);
