...
public class frmPayslipDetails : Form
{
	...
	private DataGridViewButtonColumn deletedetails_col;
	...
	private DataGridViewButtonColumn removeEmployee_col;
	...
	private void refresh_DGVEmployeeSalary()
	{
		...
		DataTable dataTable = (from row in employeeSalaryTable.AsEnumerable()
			where row.Field<int>("mode_of_salary") == 0
			select row).CopyToDataTable();
		DGVEmployeeSalary.DataSource = dataTable;
		if (DGVEmployeeSalary.Rows.Count >= dataTable.Rows.Count)
		{
	...
	private void DGVEmployeeSalary_CellClick(object sender, DataGridViewCellEventArgs e)
	{
		...
		if (columnIndex == DGVEmployeeSalary.Columns[removeEmployee_col.Name].Index)
		{
			...
			dynamic employeeObject = employeeCtrl.getEmployeeObject(value);
			int num = 1;
			int num2 = employeeCtrl.setEmployeModeSalary(employeeObject, num);
			if (num2 > 0)
			{
				refresh_DGVEmployeeSalary();
			}
	...
	{
		using PayrollCtrl payrollCtrl = new PayrollCtrl();
		DataTable payslipdetailsTable = payrollCtrl.getPayslipdetailsTable(payslip.id, idemplyee);
	...
	private void DGVPayslipDetails_CellClick(object sender, DataGridViewCellEventArgs e)
	{
		...
		int idemplyee = Convert.ToInt32(DGVEmployeeSalary.CurrentRow.Cells[idemployee_col.Name].Value);
		...
		{
			if (columnIndex != DGVPayslipDetails.Columns[deletedetails_col.Name].Index)
			{
				return;
			}
			DialogResult dialogResult = MessageBox.Show("Do you wnat to delete this record?", "Information", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
			if (dialogResult != DialogResult.No)
			{
				using (PayrollCtrl payrollCtrl = new PayrollCtrl())
				{
					int num2 = payrollCtrl.deletePayslipDetails(num);
					refresh_DGVPayslipDetails(idemplyee);
				}
			}
		}
	}
	...
	{
		DialogResult dialogResult = MessageBox.Show("Re-updating will automatically update \n the changes made in Loans/Cash Adavances and Other Benefits.\n Do you want to continue?", "Warning", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation);
		if (dialogResult == DialogResult.Yes)
		{
			using (PayrollCtrl payrollCtrl = new PayrollCtrl())
			{
				payslip.recordstatus = "new";
				int num = payrollCtrl.edit_payslip(payslip);
				dynamic value = DGVEmployeeSalary.CurrentRow.Cells[idemployee_col.Name].Value;
				payrollCtrl.getneratePayslipdetails(payslip.id);
				refresh_DGVPayslipDetails(value);
			}
		}
	}
	...
	private void btnAddEmployee_Click(object sender, EventArgs e)
	{
		...
		Employee employee = frmSearchEmployee2.sel_row;
		if (employee != null)
		{
			using (EmployeeCtrl employeeCtrl = new EmployeeCtrl())
			{
				int mode_of_salary = 0;
				int num = employeeCtrl.setEmployeModeSalary(employee, mode_of_salary);
				int num2 = employeeCtrl.generate_payslipdetailsSingle(payslip.id, employee.idemployee);
				refresh_DGVEmployeeSalary();
				return;
			}
		}
	...
	private void InitializeComponent()
	{
		...
		this.deletedetails_col = new System.Windows.Forms.DataGridViewButtonColumn();
		...
		this.removeEmployee_col = new System.Windows.Forms.DataGridViewButtonColumn();
		...
		this.splitContainer1.Panel2.Controls.Add(this.btnReupdate);
		...
		this.DGVEmployeeSalary.Columns.AddRange(this.idemployee_col, this.fullname_col, this.salary_col, this.adddetails_col, this.removeEmployee_col);
		this.DGVEmployeeSalary.Location = new System.Drawing.Point(3, 64);
		...
		this.DGVEmployeeSalary.Size = new System.Drawing.Size(438, 471);
		...
		this.DGVPayslipDetails.Columns.AddRange(this.idpayslipdetails_col, this.dataGridViewTextBoxColumn1, this.title_col, this.payslipcategory_col, this.amountpayslipdetails_col, this.editpaylisdetails_col, this.deletedetails_col);
		...
		this.amountpayslipdetails_col.DefaultCellStyle = dataGridViewCellStyle;
		...
		this.editpaylisdetails_col.DefaultCellStyle = dataGridViewCellStyle2;
		...
		this.editpaylisdetails_col.Visible = false;
		dataGridViewCellStyle3.Alignment = System.Windows.Forms.DataGridViewContentAlignment.MiddleCenter;
		dataGridViewCellStyle3.ForeColor = System.Drawing.Color.Red;
		dataGridViewCellStyle3.Padding = new System.Windows.Forms.Padding(1);
		this.deletedetails_col.DefaultCellStyle = dataGridViewCellStyle3;
		this.deletedetails_col.FlatStyle = System.Windows.Forms.FlatStyle.Flat;
		this.deletedetails_col.HeaderText = "delete";
		this.deletedetails_col.Name = "deletedetails_col";
		this.deletedetails_col.ReadOnly = true;
		this.deletedetails_col.Text = "delete";
		this.deletedetails_col.ToolTipText = "Delete Record";
		this.deletedetails_col.UseColumnTextForButtonValue = true;
		this.splitter2.Location = new System.Drawing.Point(3, 0);
		this.splitter2.Name = "splitter2";
		this.splitter2.Size = new System.Drawing.Size(8, 538);
		this.splitter2.TabIndex = 19;
		this.splitter2.TabStop = false;
		this.btnReupdate.BackColor = System.Drawing.Color.FromArgb(0, 0, 192);
		this.btnReupdate.Cursor = System.Windows.Forms.Cursors.Hand;
		this.btnReupdate.FlatAppearance.BorderSize = 0;
		this.btnReupdate.FlatStyle = System.Windows.Forms.FlatStyle.Flat;
		this.btnReupdate.ForeColor = System.Drawing.Color.White;
		this.btnReupdate.Location = new System.Drawing.Point(356, 23);
		this.btnReupdate.Name = "btnReupdate";
		this.btnReupdate.Size = new System.Drawing.Size(150, 35);
		this.btnReupdate.TabIndex = 17;
		this.btnReupdate.Text = "Re-Update";
		this.btnReupdate.UseVisualStyleBackColor = false;
		this.btnReupdate.Click += new System.EventHandler(btnReupdate_Click);
		...
		this.payroll_edit_settings_col.DefaultCellStyle = dataGridViewCellStyle4;
		...
		this.payroll_remove_settings_col.DefaultCellStyle = dataGridViewCellStyle5;
		...
		this.btnAddEmployee.Anchor = System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right;
		...
		this.btnAddEmployee.Location = new System.Drawing.Point(261, 23);
		this.btnAddEmployee.Name = "btnAddEmployee";
		this.btnAddEmployee.Size = new System.Drawing.Size(180, 35);
		...
		this.salary_col.DefaultCellStyle = dataGridViewCellStyle6;
		...
		this.adddetails_col.DefaultCellStyle = dataGridViewCellStyle7;
		...
		this.removeEmployee_col.AutoSizeMode = System.Windows.Forms.DataGridViewAutoSizeColumnMode.DisplayedCellsExceptHeader;
		...
		this.removeEmployee_col.DefaultCellStyle = dataGridViewCellStyle8;
		this.removeEmployee_col.FlatStyle = System.Windows.Forms.FlatStyle.Flat;
		this.removeEmployee_col.HeaderText = "remove";
		this.removeEmployee_col.Name = "removeEmployee_col";
		this.removeEmployee_col.ReadOnly = true;
		this.removeEmployee_col.Resizable = System.Windows.Forms.DataGridViewTriState.True;
		this.removeEmployee_col.SortMode = System.Windows.Forms.DataGridViewColumnSortMode.Automatic;
		this.removeEmployee_col.Text = "remove";
		this.removeEmployee_col.ToolTipText = "exclude from payslip";
		this.removeEmployee_col.UseColumnTextForButtonValue = true;
		this.removeEmployee_col.Width = 5;
