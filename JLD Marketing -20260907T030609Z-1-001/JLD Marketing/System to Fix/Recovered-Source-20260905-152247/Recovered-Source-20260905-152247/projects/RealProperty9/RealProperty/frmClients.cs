...
public class frmClients : Form
{
	...
	private DataGridViewButtonColumn deleteProductDetails_Col;
	...
	private void DGV_Purchase_refresh(int clientID = 0)
	{
		DataTable purchaseDetailOrderTable = controller.getPurchaseDetailOrderTable(clientID);
		if (clientID == 0)
		{
			DGVPurchase.DataSource = purchaseDetailOrderTable.Clone();
		}
		else
		{
			DGVPurchase.DataSource = purchaseDetailOrderTable;
		}
	}
	...
	private void DGVPurchase_CellClick(object sender, DataGridViewCellEventArgs e)
	{
		...
		if (columnIndex != DGVPurchase.Columns["deleteProductDetails_Col"].Index || MessageBox.Show("Do you want to delete this record?", "Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.No)
		{
			return;
		}
		using PurchasedetailsCtrl purchasedetailsCtrl = new PurchasedetailsCtrl();
		int num = purchasedetailsCtrl.delete_purchasedetails(sel_row_purchase_details.id);
		if (num > 0)
		{
			DGV_Purchase_refresh(sel_row.idclients);
		}
		...
		{
			MessageBox.Show("Cannot be deleted beacause is in use.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
		}
	}
	...
	private void InitializeComponent()
	{
		...
		this.deleteProductDetails_Col = new System.Windows.Forms.DataGridViewButtonColumn();
		...
		this.DGV.Anchor = System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left;
		...
		this.DGVPurchase.Anchor = System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left | System.Windows.Forms.AnchorStyles.Right;
		this.DGVPurchase.ColumnHeadersHeightSizeMode = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode.AutoSize;
		this.DGVPurchase.Columns.AddRange(this.code_col, this.location_col, this.status_col, this.editpucahse_col, this.Details_col, this.deleteProductDetails_Col);
		...
		this.deleteProductDetails_Col.AutoSizeMode = System.Windows.Forms.DataGridViewAutoSizeColumnMode.AllCellsExceptHeader;
		dataGridViewCellStyle3.Alignment = System.Windows.Forms.DataGridViewContentAlignment.MiddleCenter;
		dataGridViewCellStyle3.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		dataGridViewCellStyle3.Padding = new System.Windows.Forms.Padding(1);
		this.deleteProductDetails_Col.DefaultCellStyle = dataGridViewCellStyle3;
		this.deleteProductDetails_Col.FlatStyle = System.Windows.Forms.FlatStyle.Flat;
		this.deleteProductDetails_Col.HeaderText = "Delete";
		this.deleteProductDetails_Col.Name = "deleteProductDetails_Col";
		this.deleteProductDetails_Col.ReadOnly = true;
		this.deleteProductDetails_Col.Text = "delete";
		this.deleteProductDetails_Col.UseColumnTextForButtonValue = true;
		this.deleteProductDetails_Col.Width = 5;
		...
		this.idclients_col.DefaultCellStyle = dataGridViewCellStyle4;
		...
		this.middlename_col.AutoSizeMode = System.Windows.Forms.DataGridViewAutoSizeColumnMode.AllCellsExceptHeader;
		...
		this.middlename_col.Width = 5;
		this.lastname_col.AutoSizeMode = System.Windows.Forms.DataGridViewAutoSizeColumnMode.AllCellsExceptHeader;
		...
		this.dateofbirth_col.Visible = false;
		...
		this.edit_col.DefaultCellStyle = dataGridViewCellStyle5;
		...
		this.delete_col.DefaultCellStyle = dataGridViewCellStyle6;
		...
		this.apply_col.AutoSizeMode = System.Windows.Forms.DataGridViewAutoSizeColumnMode.ColumnHeader;
		...
		this.apply_col.DefaultCellStyle = dataGridViewCellStyle7;
